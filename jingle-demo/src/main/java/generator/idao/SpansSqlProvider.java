...
import generator.pojo.SpansExample.Criteria;
import generator.pojo.SpansExample.Criterion;
import generator.pojo.SpansExample;
import java.util.List;
import java.util.Map;

public class SpansSqlProvider {

    public String countByExample(SpansExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("spans");
    ...
    public String deleteByExample(SpansExample example) {
        BEGIN();
        DELETE_FROM("spans");
        applyWhere(example, false);
        return SQL();
    ...
    public String insertSelective(Spans record) {
        BEGIN();
        INSERT_INTO("spans");
    ...
    public String selectByExample(SpansExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Spans record = (Spans) parameter.get("record");
        SpansExample example = (SpansExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Spans record) {
        BEGIN();
        UPDATE("spans");
    ...
    protected void applyWhere(SpansExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
