...
public interface AssetMapper {
    ...
    @Insert({
        ...
        "#{type,jdbcType=VARCHAR}, #{brand,jdbcType=VARCHAR}, #{model,jdbcType=VARCHAR}, ",
        "#{info,jdbcType=VARCHAR}, #{remark,jdbcType=VARCHAR}, #{user,jdbcType=VARCHAR}, ",
        "#{owner,jdbcType=VARCHAR}, #{createTime,jdbcType=BIGINT}, ",
    ...
    @Select({
        "select",
        "id, sn, number, type, brand, model, info, remark, user, owner, create_time, ",
        "cabinet_id, update_time, status",
        "from asset",
        "where id = #{id,jdbcType=BIGINT}"
    })
    @Results({
