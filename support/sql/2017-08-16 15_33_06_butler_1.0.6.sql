...
-- 正在导出表  butler.asset 的数据：~9 rows (大约)
...
INSERT INTO `asset` (`id`, `sn`, `number`, `type_id`, `asset_type_id`, `brand_id`, `model`, `info`, `power`, `manage_info`, `remark`, `user_id`, `owner_id`, `cabinet_id`, `create_time`, `update_time`, `start_time`, `expired_time`, `is_expired`, `status`) VALUES
	(1, '234', '1', 1, 1, 0, 'MS-5289', '三核CPU', 0, '', '', 1, 2, 1, 0, 1502433796029, 140, 150, 0, '0'),
	(2, '4325', '234234', 3, 1, 2, 'MS-86', '八天线', 0, '', '很好', 1, 2, 1, 1498632796099, 1502433815915, 140, 150, 0, '0'),
	(3, '23452', '542', 1, 0, 0, 'MS-86', '双核CPU', 0, '', '很好', 3, 2, 1, 1498632897210, 1498634408529, 0, 153, 0, '0'),
	(1502766785400711, '592', '234234', 3, 1, 2, 'MS-86', '八天线', 0, '', '很好', 2, 2, 2, 1502766785400, 1502766785400, 140, 150, 0, '0');
...
-- 正在导出表  butler.asset_history 的数据：~54 rows (大约)
...
-- 正在导出表  butler.ip_history 的数据：~11 rows (大约)
/*!40000 ALTER TABLE `ip_history` DISABLE KEYS */;
INSERT INTO `ip_history` (`id`, `ip_id`, `ip`, `asset_id`, `user_id`, `create_time`, `update_time`, `start_time`, `expired_time`, `is_expired`, `status`, `operation`) VALUES
	(15024337966652, 1, '127.0.0.3', 1, 3, 1455, 14666, 0, 150, 0, '1', 'update'),
	(150243379651898, 3, '192.168.0.3', 1, 3, 142, 143, 0, 145, 0, '1', 'update'),
	(150243379698539, 1497259305957377, '127.0.0.2', -1, 1, 1497259305949, 1497259305957, 0, 151, 1, '0', 'update'),
	(1502174719861190, 3, '192.168.0.3', 1, 0, 142, 143, 0, 145, 0, '0', 'insert'),
	(1502174728710735, 1498188174351325, '127.0.1.9', 1498632897210454, 3, 1498188174351, 1498188174351, 0, 1234123423, 0, '0', 'update'),
	(1502174763970107, 3, '192.168.0.3', 1, 3, 142, 143, 0, 145, 0, '0', 'update'),
	(1502174772718329, 2, '127.0.0.4', 1, 0, 149, 150, 0, 150, 0, '0', 'delete'),
	(1502347855737626, 1497259305949759, '127.0.0.1', 1502347842987921, 3, 1497259305949, 1497259305949, 140, 150, 0, '1', 'update'),
	(1502433796660454, 1497259305957377, '127.0.0.2', 1, 1, 1497259305949, 1497259305957, 0, 151, 1, '1', 'update'),
	(1502433796873955, 1, '127.0.0.3', -1, 3, 1455, 14666, 0, 150, 0, '0', 'update'),
	(1502433796944081, 3, '192.168.0.3', -1, 3, 142, 143, 0, 145, 0, '0', 'update');
...
INSERT INTO `ip_section` (`id`, `ip`, `user`, `start_time`, `expired_time`, `remark`, `status`) VALUES
	...
	(1500522528438001, '123.x.x.x', 2, 140, 147, 'QWE', '');
...
-- 正在导出表  butler.item_type 的数据：~29 rows (大约)
...
-- 正在导出表  butler.operation_log 的数据：~3 rows (大约)
...
INSERT INTO `pool_network` (`id`, `ip`, `asset_id`, `user_id`, `start_time`, `expired_time`, `create_time`, `update_time`, `is_expired`, `status`) VALUES
	(1, '127.0.0.3', 1, 3, 0, 150, 1455, 14666, 0, '1'),
	(3, '192.168.0.3', 1, 3, 0, 145, 142, 143, 0, '1'),
	(1497259305949759, '127.0.0.1', 1502347842987921, 3, 140, 150, 1497259305949, 1497259305949, 0, '1'),
	(1497259305957377, '127.0.0.2', 1, 1, 0, 151, 1497259305949, 1497259305957, 1, '1'),
	(1498188174311629, '127.0.1.0', 1498632897210454, 1, 0, 152, 1498188174311, 1498188174311, 0, '0'),
	(1498188174329457, '127.0.1.2', 1498632796099286, 3, 0, 1234123423, 1498188174329, 1498188174329, 0, '0'),
	(1498188174341960, '127.0.1.3', 1498632796099286, 3, 0, 1234123423, 1498188174341, 1498188174341, 0, '0'),
	(1498188174345896, '127.0.1.4', 1498632796099286, 3, 0, 1234123423, 1498188174345, 1498188174345, 0, '1'),
	(1498188174346783, '127.0.1.5', 1498632796099286, 0, 0, 1234123423, 1498188174346, 1498188174346, 0, '0'),
	(1498188174347497, '127.0.1.6', 1498632796099286, 0, 0, 1234123423, 1498188174347, 1498188174347, 0, '0'),
	(1498188174349098, '127.0.1.8', 1498632897210454, 0, 0, 1234123423, 1498188174349, 1498188174349, 0, '0'),
	(1498188174351325, '127.0.1.9', 1498632897210454, 3, 0, 1234123423, 1498188174351, 1498188174351, 0, '0');
...
CREATE TRIGGER `copy_asset_before_delete` BEFORE DELETE ON `asset` FOR EACH ROW BEGIN
  INSERT INTO asset_history(id,asset_id,sn,number,type_id,asset_type_id,brand_id,model,info,remark,user_id,owner_id,cabinet_id,
                            create_time,update_time,start_time,expired_time,status,operation)
  VALUES(
...
CREATE TRIGGER `copy_ip_before_delete` BEFORE DELETE ON `pool_network` FOR EACH ROW BEGIN
 INSERT INTO ip_history(id,ip_id,ip,asset_id,user_id,create_time,update_time,start_time,expired_time ,
